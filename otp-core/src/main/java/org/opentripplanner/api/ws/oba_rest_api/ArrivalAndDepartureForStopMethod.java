...
/**
 * Implements the {@code arrival-and-depature-for-stop} OneBusAway API method.
 * 
 * @see http://developer.onebusaway.org/modules/onebusaway-application-modules/current/api/where/methods/arrival-and-departure-for-stop.html
 */
@Path(OneBusAwayApiMethod.API_BASE_PATH + "arrival-and-departure-for-stop/{stopId}" + OneBusAwayApiMethod.API_CONTENT_TYPE)
public class ArrivalAndDepartureForStopMethod extends OneBusAwayApiMethod {
    ...
    protected TransitResponse getResponse() {
        return TransitResponseBuilder.getFailResponse(TransitResponse.Status.UNKNOWN_ERROR);
    }
}
