...
/**
 * Implements the {@code stops-for-route} OneBusAway API method.
 * 
 * @see http://developer.onebusaway.org/modules/onebusaway-application-modules/current/api/where/methods/stops-for-route.html
 */

@Path(OneBusAwayApiMethod.API_BASE_PATH + "stops-for-route/{routeId}" + OneBusAwayApiMethod.API_CONTENT_TYPE)
public class StopsForRouteMethod extends OneBusAwayApiMethod {
